	...
	<div id="header" style="text-align: center;">
		...
		<div class="col-container">
			<fieldset class="inside" >
				...
				<div class="wrapper">
							    <button class="button" type="submit" onclick="location.href='home.php'">Logout</button>
							</div>
				<!-- <table align="center" cellpadding = "10">
					<tr>
						
						<?php 
							$sql = "SELECT id, First_Name, Last_Name FROM student_login";
							$result = $conn->query($sql);

							if ($result->num_rows > 0) {
							    // output data of each row
							    while($row = $result->fetch_assoc()) {
							         "id: " . $row["id"]. " - Name: " . $row["First_Name"]. " " . $row["Last_Name"]. "<br>";
							    }
							} 
							else {
							    echo "0 results";
